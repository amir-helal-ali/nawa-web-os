...
const NAV_ITEMS = [
  ...
  { id: "memory", label: "الذاكرة", en: "Memory" },
  ...
  { id: "calculator", label: "حاسبة التوفير", en: "Calculator" },
  ...
  { id: "timeline", label: "التاريخ", en: "Timeline" },
  { id: "changelog", label: "السجل", en: "Changelog" },
