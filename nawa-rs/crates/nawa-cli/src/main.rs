...
fn print_info() {
    println!("nawa CLI v2.5.2 (NAWA Web Operating System)");
    println!("─────────────────────────────────────────────");
    println!("Components:");
    ...
    println!("  • nawad:       server binary (v2.5.2)");
    println!();
    println!("Platform:");
